...
- **DesignKinds:** справа проступает шахматка прозрачности (в экспортированный PNG затесался transparency-чекер) → переэкспортировать ассет с корректным фоном или собрать чат-UI нативно. Тёмная карточка сейчас — единый PNG-мокап (785×680), не живой UI.
...
- **Process:** шахматка в мокапе шага 2 («Let's go») — вероятно намеренный вид Figma-канвы, проверить.
